...
| | |
|---|---|
| GitHub | `maf4711/setupmacos` |
| SSH | `git@github.com:maf4711/setupmacos.git` |
| Remote dieses Checkouts | `git@github.com:maf4711/setupmacos.git` |
| Ordner | `~/Developer/setupmacos` |
| Default-Branch | `main` |
...
3. Dieser Checkout liegt danach unter `~/Developer/setupmacos`. Weicht der Ordner vom Repo-Namen ab, weil zwei Orgs denselben Namen haben, heißt er `~/Developer/<owner>--<name>`.
